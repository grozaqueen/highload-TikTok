...
| Тип трафика | Пиковое потребление | Суточный объем |
|------------|-----------------|----------------|
| Просмотр видео |  | 5 МБ - средний размер видео, 232 просмтра за одним пользователем в день, 600 млн - DAU => 600 * 232 = 139,2 млрд просмотров в день => 696 ПБ/день |
| Публикация видео | 287,6 МБ - максимально может занимать видео => 34 млн в день выкладывается (34/24/60/60 в секунду) это примерно | 5 МБ - средний размер видео, 34 млн в день публикуют = 162 ТБ/день |
| Лайки, комментарии | | 13,9 млрд в день * 1 КБ + 1,39 млрд в день * 2 КБ = 16.68 ТБ/день |
| Авторизация | | 650 тысяч в день * пусть 10 КБ на вход = 6,5 ТБ/день |

### RPS (Запросы в секунду)

| Тип запроса | Средний RPS | Пиковый RPS |
|------------|------------|-------------|
| Просмотр видео | 232 * 600 млн DAU /24/60/60 = 1611111 |  |
| Публикация видео | 0,057 видео в день публикует пользователь * 600 млн DAU /24/60/60 = 396 | |
| Комментарий | 13,9 млрд /24/60/60 = 161111 |  |
| Комментарий | 650 тысяч /24/60/60 = 8 |  |
