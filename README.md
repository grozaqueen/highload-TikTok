...
| **Итого**      | 2,715,332 | 5,432 | 2,716      | 2,716    |
...
| Категория          | Кол-во | Цена за 1 | Стоимость   | Амортизация (3 года)/мес |
| ------------------ | ------ | --------- | ----------- | --------------- |
| Kubernetes-серверы | 30     | \$6,275   | \$188,250   | \$5,229         |  
| Cassandra          | 120    | \$7,488   | \$898,560   | \$24,960        |
| Elasticsearch      | 60     | \$7,488   | \$449,280   | \$12,480        |
| Redis              | 2      | \$7,488   | \$14,976    | \$416           |
| Kafka              | 50     | \$7,488   | \$374,400   | \$10,400        |
| ClickHouse         | 20     | \$7,488   | \$149,760   | \$4,160         |
| CDN                | 480    | \$12,000  | \$5,760,000 | \$160,000       |
| **Итого**          |        |           | \$7,835,226 | **\$217,645**   |

Kubernetes-серверы: Dell PowerEdge R940 с 4x Xeon Platinum 8160, 512GB RAM — $6,275.00
Cassandra, Elasticsearch, Redis, Kafka, ClickHouse: Dell PowerEdge R750 с 2x Xeon Silver 4314, 128GB RAM — $7,488.00
CDN-серверы: Оценочная стоимость — $12,000.00

## 7. Расчет стоимости аренды инфраструктуры

#### 1. Kubernetes-серверы (30 серверов)
Конфигурация: 128 vCPU, 512GB RAM  
Аналог в облаке: AWS m6i.metal (128 vCPU, 512GB RAM)  
Стоимость: ~$4.60/час → ~$3,312/месяц за 1 сервер  
**Итого:** 30 × $3,312 = **$99,360/мес**

#### 2. Cassandra (120 нод)
Конфигурация: 32 vCPU, 128GB RAM  
Аналог: AWS r6g.8xlarge (32 vCPU, 256GB RAM)  
Стоимость: ~$2.20/час → ~$1,584/месяц  
**Итого:** 120 × $1,584 = **$190,080/мес**

#### 3. Elasticsearch (60 нод)
Конфигурация: 64 vCPU, 256GB RAM  
Аналог: AWS r6g.16xlarge (64 vCPU, 512GB RAM)  
Стоимость: ~$4.40/час → ~$3,168/месяц  
**Итого:** 60 × $3,168 = **$190,080/мес**

#### 4. Redis (2 ноды)
Конфигурация: 16 vCPU, 64GB RAM  
Аналог: AWS cache.r6g.4xlarge (16 vCPU, 128GB RAM)  
Стоимость: ~$1.50/час → ~$1,080/месяц  
**Итого:** 2 × $1,080 = **$2,160/мес**

#### 5. Kafka (50 нод)
Конфигурация: 32 vCPU, 128GB RAM  
Аналог: AWS m6g.8xlarge (32 vCPU, 128GB RAM)  
Стоимость: ~$1.50/час → ~$1,080/месяц  
**Итого:** 50 × $1,080 = **$54,000/мес**

#### 6. ClickHouse (20 нод)
Конфигурация: 64 vCPU, 256GB RAM  
Аналог: AWS r6g.16xlarge (64 vCPU, 512GB RAM)  
Стоимость: ~$4.40/час → ~$3,168/месяц  
**Итого:** 20 × $3,168 = **$63,360/мес**

#### 7. CDN (480 edge-серверов)
Ориентировочная стоимость: $500/месяц за сервер  
**Итого:** 480 × $500 = **$240,000/мес**

#### 8. Nginx балансировщики (24 сервера)
Конфигурация: 16 vCPU, 32GB RAM  
Аналог: AWS m6g.4xlarge (16 vCPU, 64GB RAM)  
Стоимость: ~$0.80/час → ~$576/месяц  
**Итого:** 24 × $576 = **$13,824/мес**

### Итого стоимость аренды в месяц:

| Компонент         | Количество | Стоимость/мес | Общая стоимость/мес |
|-------------------|------------|---------------|---------------------|
| Kubernetes        | 30         | $3,312        | $99,360             |
| Cassandra         | 120        | $1,584        | $190,080            |
| Elasticsearch     | 60         | $3,168        | $190,080            |
| Redis             | 2          | $1,080        | $2,160              |
| Kafka             | 50         | $1,080        | $54,000             |
| ClickHouse        | 20         | $3,168        | $63,360             |
| CDN               | 480        | $500          | $240,000            |
| Nginx             | 24         | $576          | $13,824             |
| **Всего**         |            |               | **$852,864**        |
...
1. **Амортизация** (5 лет = 60 месяцев):
$7,835,226 / 60 = **$130,587/мес**

2. **Электроэнергия**:
- Общее количество серверов: 30+120+60+2+50+20+480+24 = 786
- Среднее потребление: 500 Вт
- Общее потребление: 786 * 0.5 кВт = 393 кВт
- Месячное потребление: 393 * 24 * 30 = 282,960 кВт·ч
- Стоимость: 282,960 * $0.10 = **$28,296/мес**

3. **Другие расходы** (обслуживание, охлаждение):
30% от электроэнергии = **$8,489/мес**

Итого операционных расходов: $130,587 + $28,296 + $8,489 = **$167,372/мес**

### Пересчет окупаемости:

1. Капитальные затраты: $7,835,226
2. Операционные расходы при покупке: $167,372/мес
3. Стоимость аренды: $852,864/мес

Экономия при покупке: $852,864 - $167,372 = $685,492/мес

Срок окупаемости: $7,835,226 / $685,492 ≈ 11.4 месяцев
